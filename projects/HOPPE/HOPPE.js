...
ApplicationMain.preload = function() {
	...
	ApplicationMain.loadFile("assets/images/Button.png");
	ApplicationMain.loadFile("assets/images/Icon.png");
	ApplicationMain.loadBinary("assets/images/images-go-here.txt");
	ApplicationMain.loadFile("assets/images/particles.png");
	ApplicationMain.loadBinary("assets/maps/level_01.tmx");
...
var BottomFloor = function() {
	flixel.FlxSprite.call(this,0,flixel.FlxG.height - 16);
	this.makeGraphic(flixel.FlxG.width,16,-1);
	this.set_immovable(true);
};
$hxClasses["BottomFloor"] = BottomFloor;
BottomFloor.__name__ = ["BottomFloor"];
BottomFloor.__super__ = flixel.FlxSprite;
BottomFloor.prototype = $extend(flixel.FlxSprite.prototype,{
	__class__: BottomFloor
});
var openfl = {};
...
var DefaultAssetLibrary = function() {
	...
	this.add("assets/data/data-goes-here.txt",openfl.AssetType.TEXT);
	this.add("assets/images/Button.png",openfl.AssetType.IMAGE);
	this.add("assets/images/Icon.png",openfl.AssetType.IMAGE);
	this.add("assets/images/images-go-here.txt",openfl.AssetType.TEXT);
	this.add("assets/images/particles.png",openfl.AssetType.IMAGE);
	this.add("assets/maps/level_01.tmx",openfl.AssetType.TEXT);
	...
	this.add("assets/sounds/beep.mp3",openfl.AssetType.MUSIC);
	this.add("assets/sounds/flixel.mp3",openfl.AssetType.MUSIC);
	this.add("assets/sounds/beep.ogg",openfl.AssetType.SOUND);
...
MenuState.prototype = $extend(flixel.FlxState.prototype,{
	start: null
	,create: function() {
		this.start = new flixel.ui.FlxButton(0,0,"Start",$bind(this,this.play));
		this.start.loadGraphic("assets/images/Button.png");
		this.start.label.set_color(-1);
		flixel.util.FlxSpriteUtil.screenCenter(this.start,true,true);
		this.add(this.start);
...
var Pillar = function() {
	flixel.FlxSprite.call(this,flixel.FlxG.width / 2 - 8 | 0,flixel.FlxG.height - 48);
	this.makeGraphic(16,32,-663885);
	this.set_immovable(true);
};
$hxClasses["Pillar"] = Pillar;
Pillar.__name__ = ["Pillar"];
Pillar.__super__ = flixel.FlxSprite;
Pillar.prototype = $extend(flixel.FlxSprite.prototype,{
	__class__: Pillar
});
...
PlayState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,create: function() {
		...
		this.map = new flixel.group.FlxGroup();
		this.floor = new BottomFloor();
		this.pillar = new Pillar();
		this.left = new SideWall(0);
		this.right = new SideWall(flixel.FlxG.width - 16);
		this.scoreText = new flixel.text.FlxText(0,10,null,"");
		this.scoreText.set_color(-1);
		this.scoreText.set_size(16);
		this.emitter = new flixel.effects.particles.FlxEmitter();
		this.emitter.setRotation(0,0);
		this.emitter.makeParticles("assets/images/particles.png",45,0,true,0);
		this.emitter.setAlpha(1,1,0,0);
		flixel.util.FlxSpriteUtil.screenCenter(this.scoreText,true,false);
		this.map.add(this.floor);
		this.map.add(this.left);
		this.map.add(this.right);
	...
	,update: function() {
		flixel.FlxState.prototype.update.call(this);
		flixel.FlxG.overlap(this.player,this.map,null,flixel.FlxObject.separate);
		this.scoreText.set_text("" + this.points);
		if(this.player.justTouched(1) && !this.isDead) {
			this.player.set_facing(16);
			if(!flixel.FlxG.overlap(this.player,this.pillar,null,flixel.FlxObject.separate)) this.points++;
			this.player.velocity.set_x(200 + this.points * 5);
		}
		if(this.player.justTouched(16) && !this.isDead) {
			this.player.set_facing(1);
			if(!flixel.FlxG.overlap(this.player,this.pillar,null,flixel.FlxObject.separate)) this.points++;
			this.player.velocity.set_x(-200 - this.points * 5);
		}
		var _g = 0;
		var _g1 = flixel.FlxG.touches.list;
		while(_g < _g1.length) {
			var touch = _g1[_g];
			++_g;
			if(touch._current > 0) {
				if((this.player.touching & 4096) > 0) this.player.velocity.set_y(-200);
			}
		}
		if(flixel.FlxG.overlap(this.player,this.pillar,null,flixel.FlxObject.separate)) {
			this.isDead = true;
			this.gameOver = true;
		}
		if(this.isDead && this.gameOver) {
			...
			this.restart = new flixel.ui.FlxButton(0,0,"Restart?",$bind(this,this.restartGame));
			this.restart.label.set_color(-1);
			this.restart.loadGraphic("assets/images/Button.png");
			flixel.util.FlxSpriteUtil.screenCenter(this.restart,true,true);
	...
	,explode: function(X,Y) {
		...
		if(X == 0 && Y == 0) {
			...
			Y = flixel.FlxG.height / 2;
		}
		if(this.emitter.visible) {
			this.emitter.set_x(X);
			this.emitter.set_y(Y);
			this.emitter.start(true,2,0,400);
			this.emitter.update();
		}
	}
	,__class__: PlayState
...
var Player = function() {
	flixel.FlxSprite.call(this,flixel.FlxG.width / 2 - 8 | 0,flixel.FlxG.height / 2);
	this.makeGraphic(16,16,-1);
	this.antialiasing = false;
	this.acceleration.set_y(500);
...
var SideWall = function(x) {
	flixel.FlxSprite.call(this,x,0);
	this.makeGraphic(16,flixel.FlxG.height,-1);
	this.set_immovable(true);
};
$hxClasses["SideWall"] = SideWall;
SideWall.__name__ = ["SideWall"];
SideWall.__super__ = flixel.FlxSprite;
SideWall.prototype = $extend(flixel.FlxSprite.prototype,{
	__class__: SideWall
});
var Std = function() { };
$hxClasses["Std"] = Std;
...
flixel.effects.particles.FlxTypedEmitter = function(X,Y,Size) {
	if(Size == null) Size = 0;
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	...
	this.frequency = 0.1;
	this.on = false;
	flixel.group.FlxTypedGroup.call(this,Size);
	this.xPosition = new flixel.effects.particles.Bounds(X,0);
	this.yPosition = new flixel.effects.particles.Bounds(Y,0);
	this.xVelocity = new flixel.effects.particles.Bounds(-100,100);
	this.yVelocity = new flixel.effects.particles.Bounds(-100,100);
	this.rotation = new flixel.effects.particles.Bounds(-360,360);
	this.startScale = new flixel.effects.particles.Bounds(1,1);
	this.endScale = new flixel.effects.particles.Bounds(1,1);
	this.startAlpha = new flixel.effects.particles.Bounds(1.0,1.0);
	this.endAlpha = new flixel.effects.particles.Bounds(1.0,1.0);
	this.startRed = new flixel.effects.particles.Bounds(1.0,1.0);
	this.startGreen = new flixel.effects.particles.Bounds(1.0,1.0);
	this.startBlue = new flixel.effects.particles.Bounds(1.0,1.0);
	this.endRed = new flixel.effects.particles.Bounds(1.0,1.0);
	this.endGreen = new flixel.effects.particles.Bounds(1.0,1.0);
	this.endBlue = new flixel.effects.particles.Bounds(1.0,1.0);
	this.acceleration = flixel.util.FlxPoint.get(0,0);
	this._particleClass = flixel.effects.particles.FlxParticle;
	this.particleDrag = flixel.util.FlxPoint.get(null,null);
	this.life = new flixel.effects.particles.Bounds(3,3);
	this.set_exists(false);
	this._point = flixel.util.FlxPoint.get(null,null);
};
$hxClasses["flixel.effects.particles.FlxTypedEmitter"] = flixel.effects.particles.FlxTypedEmitter;
flixel.effects.particles.FlxTypedEmitter.__name__ = ["flixel","effects","particles","FlxTypedEmitter"];
flixel.effects.particles.FlxTypedEmitter.__super__ = flixel.group.FlxTypedGroup;
flixel.effects.particles.FlxTypedEmitter.prototype = $extend(flixel.group.FlxTypedGroup.prototype,{
	xPosition: null
	,yPosition: null
	,xVelocity: null
	,yVelocity: null
	...
	,destroy: function() {
		this._point = flixel.util.FlxDestroyUtil.put(this._point);
		this.acceleration = flixel.util.FlxDestroyUtil.put(this.acceleration);
		this.particleDrag = flixel.util.FlxDestroyUtil.put(this.particleDrag);
		this.xPosition = null;
		this.yPosition = null;
		this.xVelocity = null;
		this.yVelocity = null;
		...
		this.blend = null;
		this._point = null;
		flixel.group.FlxTypedGroup.prototype.destroy.call(this);
	}
	,makeParticles: function(Graphics,Quantity,bakedRotationAngles,Multiple,Collide,AutoBuffer) {
		...
		while(i < Quantity) {
			...
			if(Multiple) {
				randomFrame = flixel.util.FlxRandom.intRanged(0,totalFrames - 1);
	...
	,update: function() {
		...
		flixel.group.FlxTypedGroup.prototype.update.call(this);
	}
	,kill: function() {
		this.on = false;
		this._waitForKill = false;
		flixel.group.FlxTypedGroup.prototype.kill.call(this);
	}
	...
	,emitParticle: function() {
		...
		particle.reset(this.get_x() - (Std["int"](particle.get_width()) >> 1) + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * this.get_width(),this.get_y() - (Std["int"](particle.get_height()) >> 1) + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * this.get_height());
		particle.set_visible(true);
		if(this.life.min != this.life.max) particle.lifespan = particle.maxLifespan = this.life.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.life.max - this.life.min); else particle.lifespan = particle.maxLifespan = this.life.min;
		if(this.startAlpha.min != this.startAlpha.max) particle.startAlpha = this.startAlpha.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.startAlpha.max - this.startAlpha.min); else particle.startAlpha = this.startAlpha.min;
		particle.set_alpha(particle.startAlpha);
		var particleEndAlpha = this.endAlpha.min;
		if(this.endAlpha.min != this.endAlpha.max) particleEndAlpha = this.endAlpha.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.endAlpha.max - this.endAlpha.min);
		...
		if(this.startRed.min != this.startRed.max) particle.startRed = startRedComp = this.startRed.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.startRed.max - this.startRed.min);
		if(this.startGreen.min != this.startGreen.max) particle.startGreen = startGreenComp = this.startGreen.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.startGreen.max - this.startGreen.min);
		if(this.startBlue.min != this.startBlue.max) particle.startBlue = startBlueComp = this.startBlue.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.startBlue.max - this.startBlue.min);
		if(this.endRed.min != this.endRed.max) endRedComp = this.endRed.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.endRed.max - this.endRed.min);
		if(this.endGreen.min != this.endGreen.max) endGreenComp = this.endGreen.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.endGreen.max - this.endGreen.min);
		if(this.endBlue.min != this.endBlue.max) endBlueComp = this.endBlue.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.endBlue.max - this.endBlue.min);
		...
		if(this.startScale.min != this.startScale.max) particle.startScale = this.startScale.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.startScale.max - this.startScale.min); else particle.startScale = this.startScale.min;
		particle.scale.set_x(particle.scale.set_y(particle.startScale));
		var particleEndScale = this.endScale.min;
		if(this.endScale.min != this.endScale.max) particleEndScale = this.endScale.min + flixel.util.FlxRandom.intRanged(0,this.endScale.max - this.endScale.min | 0);
		...
		if(this.xVelocity.min != this.xVelocity.max) particle.velocity.set_x(this.xVelocity.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.xVelocity.max - this.xVelocity.min)); else particle.velocity.set_x(this.xVelocity.min);
		if(this.yVelocity.min != this.yVelocity.max) particle.velocity.set_y(this.yVelocity.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.yVelocity.max - this.yVelocity.min)); else particle.velocity.set_y(this.yVelocity.min);
		particle.acceleration.set(this.acceleration.x,this.acceleration.y);
		if(this.rotation.min != this.rotation.max) particle.angularVelocity = this.rotation.min + (flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * (this.rotation.max - this.rotation.min); else particle.angularVelocity = this.rotation.min;
		if(particle.angularVelocity != 0) particle.set_angle((flixel.util.FlxRandom._internalSeed = flixel.util.FlxRandom._internalSeed * 48271 % 2147483647 & 2147483647) / 2147483647 * 360 - 180);
	...
	,__class__: flixel.effects.particles.FlxTypedEmitter
	,__properties__: $extend(flixel.group.FlxTypedGroup.prototype.__properties__,{set_lifespan:"set_lifespan",get_lifespan:"get_lifespan",set_maxRotation:"set_maxRotation",get_maxRotation:"get_maxRotation",set_minRotation:"set_minRotation",get_minRotation:"get_minRotation",set_gravity:"set_gravity",get_gravity:"get_gravity",set_y:"set_y",get_y:"get_y",set_x:"set_x",get_x:"get_x",set_height:"set_height",get_height:"get_height",set_width:"set_width",get_width:"get_width",set_particleClass:"set_particleClass",get_particleClass:"get_particleClass"})
});
flixel.effects.particles.FlxEmitter = function(X,Y,Size) {
	if(Size == null) Size = 0;
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	flixel.effects.particles.FlxTypedEmitter.call(this,X,Y,Size);
};
$hxClasses["flixel.effects.particles.FlxEmitter"] = flixel.effects.particles.FlxEmitter;
flixel.effects.particles.FlxEmitter.__name__ = ["flixel","effects","particles","FlxEmitter"];
flixel.effects.particles.FlxEmitter.__super__ = flixel.effects.particles.FlxTypedEmitter;
flixel.effects.particles.FlxEmitter.prototype = $extend(flixel.effects.particles.FlxTypedEmitter.prototype,{
	__class__: flixel.effects.particles.FlxEmitter
});
flixel.interfaces.IFlxBasic = function() { };
$hxClasses["flixel.interfaces.IFlxBasic"] = flixel.interfaces.IFlxBasic;
flixel.interfaces.IFlxBasic.__name__ = ["flixel","interfaces","IFlxBasic"];
flixel.interfaces.IFlxBasic.prototype = {
	ID: null
	,active: null
	,visible: null
	,alive: null
	...
	,revive: null
	,toString: null
	,__class__: flixel.interfaces.IFlxBasic
};
flixel.interfaces.IFlxSprite = function() { };
$hxClasses["flixel.interfaces.IFlxSprite"] = flixel.interfaces.IFlxSprite;
flixel.interfaces.IFlxSprite.__name__ = ["flixel","interfaces","IFlxSprite"];
flixel.interfaces.IFlxSprite.__interfaces__ = [flixel.interfaces.IFlxBasic];
flixel.interfaces.IFlxSprite.prototype = {
	x: null
	,y: null
	,alpha: null
	,angle: null
	...
	,reset: null
	,setPosition: null
	,__class__: flixel.interfaces.IFlxSprite
};
flixel.interfaces.IFlxParticle = function() { };
$hxClasses["flixel.interfaces.IFlxParticle"] = flixel.interfaces.IFlxParticle;
flixel.interfaces.IFlxParticle.__name__ = ["flixel","interfaces","IFlxParticle"];
flixel.interfaces.IFlxParticle.__interfaces__ = [flixel.interfaces.IFlxSprite];
flixel.interfaces.IFlxParticle.prototype = {
	lifespan: null
	,friction: null
	,useFading: null
	,useScaling: null
	...
	,rangeBlue: null
	,onEmit: null
	,__class__: flixel.interfaces.IFlxParticle
};
flixel.effects.particles.FlxParticle = function() {
...
$hxClasses["flixel.effects.particles.FlxParticle"] = flixel.effects.particles.FlxParticle;
flixel.effects.particles.FlxParticle.__name__ = ["flixel","effects","particles","FlxParticle"];
flixel.effects.particles.FlxParticle.__interfaces__ = [flixel.interfaces.IFlxParticle];
flixel.effects.particles.FlxParticle.__super__ = flixel.FlxSprite;
flixel.effects.particles.FlxParticle.prototype = $extend(flixel.FlxSprite.prototype,{
	lifespan: null
	,friction: null
	,useFading: null
	,useScaling: null
	...
	,update: function() {
		...
		if(this.exists && this.alive) flixel.FlxSprite.prototype.update.call(this);
	}
	,reset: function(X,Y) {
		flixel.FlxSprite.prototype.reset.call(this,X,Y);
		this.set_alpha(1.0);
	...
	,__class__: flixel.effects.particles.FlxParticle
});
flixel.effects.particles.Bounds = function(min,max) {
	this.set(min,max);
};
$hxClasses["flixel.effects.particles.Bounds"] = flixel.effects.particles.Bounds;
flixel.effects.particles.Bounds.__name__ = ["flixel","effects","particles","Bounds"];
flixel.effects.particles.Bounds.prototype = {
	min: null
	,max: null
	...
	,__class__: flixel.effects.particles.Bounds
};
...
flixel.ui._FlxVirtualPad = {};
flixel.ui._FlxVirtualPad.GraphicA = function(width,height,transparent,color) {
	var o = flixel.ui._FlxVirtualPad.GraphicA.image;
	flash.display.BitmapData.call(this,o.width,o.height,true,0);
	this.qContext.drawImage(o,0,0);
};
$hxClasses["flixel.ui._FlxVirtualPad.GraphicA"] = flixel.ui._FlxVirtualPad.GraphicA;
flixel.ui._FlxVirtualPad.GraphicA.__name__ = ["flixel","ui","_FlxVirtualPad","GraphicA"];
flixel.ui._FlxVirtualPad.GraphicA.preload = function() {
	var o = document.createElement("img");
	ApplicationMain.loadEmbed(o);
	o.src = "data:image/png;base64,";
	flixel.ui._FlxVirtualPad.GraphicA.image = o;
};
flixel.ui._FlxVirtualPad.GraphicA.__super__ = flash.display.BitmapData;
flixel.ui._FlxVirtualPad.GraphicA.prototype = $extend(flash.display.BitmapData.prototype,{
	__class__: flixel.ui._FlxVirtualPad.GraphicA
});
flixel.ui._FlxVirtualPad.GraphicB = function(width,height,transparent,color) {
	var o = flixel.ui._FlxVirtualPad.GraphicB.image;
	flash.display.BitmapData.call(this,o.width,o.height,true,0);
	this.qContext.drawImage(o,0,0);
};
$hxClasses["flixel.ui._FlxVirtualPad.GraphicB"] = flixel.ui._FlxVirtualPad.GraphicB;
flixel.ui._FlxVirtualPad.GraphicB.__name__ = ["flixel","ui","_FlxVirtualPad","GraphicB"];
flixel.ui._FlxVirtualPad.GraphicB.preload = function() {
	var o = document.createElement("img");
	ApplicationMain.loadEmbed(o);
	o.src = "data:image/png;base64,";
	flixel.ui._FlxVirtualPad.GraphicB.image = o;
};
flixel.ui._FlxVirtualPad.GraphicB.__super__ = flash.display.BitmapData;
flixel.ui._FlxVirtualPad.GraphicB.prototype = $extend(flash.display.BitmapData.prototype,{
	__class__: flixel.ui._FlxVirtualPad.GraphicB
});
flixel.ui._FlxVirtualPad.GraphicC = function(width,height,transparent,color) {
	var o = flixel.ui._FlxVirtualPad.GraphicC.image;
	flash.display.BitmapData.call(this,o.width,o.height,true,0);
	this.qContext.drawImage(o,0,0);
};
$hxClasses["flixel.ui._FlxVirtualPad.GraphicC"] = flixel.ui._FlxVirtualPad.GraphicC;
flixel.ui._FlxVirtualPad.GraphicC.__name__ = ["flixel","ui","_FlxVirtualPad","GraphicC"];
flixel.ui._FlxVirtualPad.GraphicC.preload = function() {
	var o = document.createElement("img");
	ApplicationMain.loadEmbed(o);
	o.src = "data:image/png;base64,";
	flixel.ui._FlxVirtualPad.GraphicC.image = o;
};
flixel.ui._FlxVirtualPad.GraphicC.__super__ = flash.display.BitmapData;
flixel.ui._FlxVirtualPad.GraphicC.prototype = $extend(flash.display.BitmapData.prototype,{
	__class__: flixel.ui._FlxVirtualPad.GraphicC
});
flixel.ui._FlxVirtualPad.GraphicDown = function(width,height,transparent,color) {
	var o = flixel.ui._FlxVirtualPad.GraphicDown.image;
	flash.display.BitmapData.call(this,o.width,o.height,true,0);
	this.qContext.drawImage(o,0,0);
};
$hxClasses["flixel.ui._FlxVirtualPad.GraphicDown"] = flixel.ui._FlxVirtualPad.GraphicDown;
flixel.ui._FlxVirtualPad.GraphicDown.__name__ = ["flixel","ui","_FlxVirtualPad","GraphicDown"];
flixel.ui._FlxVirtualPad.GraphicDown.preload = function() {
	var o = document.createElement("img");
	ApplicationMain.loadEmbed(o);
	o.src = "data:image/png;base64,";
	flixel.ui._FlxVirtualPad.GraphicDown.image = o;
};
flixel.ui._FlxVirtualPad.GraphicDown.__super__ = flash.display.BitmapData;
flixel.ui._FlxVirtualPad.GraphicDown.prototype = $extend(flash.display.BitmapData.prototype,{
	__class__: flixel.ui._FlxVirtualPad.GraphicDown
});
flixel.ui._FlxVirtualPad.GraphicLeft = function(width,height,transparent,color) {
	var o = flixel.ui._FlxVirtualPad.GraphicLeft.image;
	flash.display.BitmapData.call(this,o.width,o.height,true,0);
	this.qContext.drawImage(o,0,0);
};
$hxClasses["flixel.ui._FlxVirtualPad.GraphicLeft"] = flixel.ui._FlxVirtualPad.GraphicLeft;
flixel.ui._FlxVirtualPad.GraphicLeft.__name__ = ["flixel","ui","_FlxVirtualPad","GraphicLeft"];
flixel.ui._FlxVirtualPad.GraphicLeft.preload = function() {
	var o = document.createElement("img");
	ApplicationMain.loadEmbed(o);
	o.src = "data:image/png;base64,";
	flixel.ui._FlxVirtualPad.GraphicLeft.image = o;
};
flixel.ui._FlxVirtualPad.GraphicLeft.__super__ = flash.display.BitmapData;
flixel.ui._FlxVirtualPad.GraphicLeft.prototype = $extend(flash.display.BitmapData.prototype,{
	__class__: flixel.ui._FlxVirtualPad.GraphicLeft
});
flixel.ui._FlxVirtualPad.GraphicRight = function(width,height,transparent,color) {
	var o = flixel.ui._FlxVirtualPad.GraphicRight.image;
	flash.display.BitmapData.call(this,o.width,o.height,true,0);
	this.qContext.drawImage(o,0,0);
};
$hxClasses["flixel.ui._FlxVirtualPad.GraphicRight"] = flixel.ui._FlxVirtualPad.GraphicRight;
flixel.ui._FlxVirtualPad.GraphicRight.__name__ = ["flixel","ui","_FlxVirtualPad","GraphicRight"];
flixel.ui._FlxVirtualPad.GraphicRight.preload = function() {
	var o = document.createElement("img");
	ApplicationMain.loadEmbed(o);
	o.src = "data:image/png;base64,";
	flixel.ui._FlxVirtualPad.GraphicRight.image = o;
};
flixel.ui._FlxVirtualPad.GraphicRight.__super__ = flash.display.BitmapData;
flixel.ui._FlxVirtualPad.GraphicRight.prototype = $extend(flash.display.BitmapData.prototype,{
	__class__: flixel.ui._FlxVirtualPad.GraphicRight
});
flixel.ui._FlxVirtualPad.GraphicUp = function(width,height,transparent,color) {
	var o = flixel.ui._FlxVirtualPad.GraphicUp.image;
	flash.display.BitmapData.call(this,o.width,o.height,true,0);
	this.qContext.drawImage(o,0,0);
};
$hxClasses["flixel.ui._FlxVirtualPad.GraphicUp"] = flixel.ui._FlxVirtualPad.GraphicUp;
flixel.ui._FlxVirtualPad.GraphicUp.__name__ = ["flixel","ui","_FlxVirtualPad","GraphicUp"];
flixel.ui._FlxVirtualPad.GraphicUp.preload = function() {
	var o = document.createElement("img");
	ApplicationMain.loadEmbed(o);
	o.src = "data:image/png;base64,";
	flixel.ui._FlxVirtualPad.GraphicUp.image = o;
};
flixel.ui._FlxVirtualPad.GraphicUp.__super__ = flash.display.BitmapData;
flixel.ui._FlxVirtualPad.GraphicUp.prototype = $extend(flash.display.BitmapData.prototype,{
	__class__: flixel.ui._FlxVirtualPad.GraphicUp
});
flixel.ui._FlxVirtualPad.GraphicX = function(width,height,transparent,color) {
	var o = flixel.ui._FlxVirtualPad.GraphicX.image;
	flash.display.BitmapData.call(this,o.width,o.height,true,0);
	this.qContext.drawImage(o,0,0);
};
$hxClasses["flixel.ui._FlxVirtualPad.GraphicX"] = flixel.ui._FlxVirtualPad.GraphicX;
flixel.ui._FlxVirtualPad.GraphicX.__name__ = ["flixel","ui","_FlxVirtualPad","GraphicX"];
flixel.ui._FlxVirtualPad.GraphicX.preload = function() {
	var o = document.createElement("img");
	ApplicationMain.loadEmbed(o);
	o.src = "data:image/png;base64,";
	flixel.ui._FlxVirtualPad.GraphicX.image = o;
};
flixel.ui._FlxVirtualPad.GraphicX.__super__ = flash.display.BitmapData;
flixel.ui._FlxVirtualPad.GraphicX.prototype = $extend(flash.display.BitmapData.prototype,{
	__class__: flixel.ui._FlxVirtualPad.GraphicX
});
flixel.ui._FlxVirtualPad.GraphicY = function(width,height,transparent,color) {
	var o = flixel.ui._FlxVirtualPad.GraphicY.image;
	flash.display.BitmapData.call(this,o.width,o.height,true,0);
	this.qContext.drawImage(o,0,0);
};
$hxClasses["flixel.ui._FlxVirtualPad.GraphicY"] = flixel.ui._FlxVirtualPad.GraphicY;
flixel.ui._FlxVirtualPad.GraphicY.__name__ = ["flixel","ui","_FlxVirtualPad","GraphicY"];
flixel.ui._FlxVirtualPad.GraphicY.preload = function() {
	var o = document.createElement("img");
	ApplicationMain.loadEmbed(o);
	o.src = "data:image/png;base64,";
	flixel.ui._FlxVirtualPad.GraphicY.image = o;
};
flixel.ui._FlxVirtualPad.GraphicY.__super__ = flash.display.BitmapData;
flixel.ui._FlxVirtualPad.GraphicY.prototype = $extend(flash.display.BitmapData.prototype,{
	__class__: flixel.ui._FlxVirtualPad.GraphicY
});
flixel.ui.FlxVirtualPad = function(DPad,Action) {
	flixel.group.FlxSpriteGroup.call(this);
	this.scrollFactor.set();
	if(DPad == null) DPad = flixel.ui.DPadMode.FULL;
	if(Action == null) Action = flixel.ui.ActionMode.A_B_C;
	this.dPad = new flixel.group.FlxSpriteGroup();
	this.dPad.scrollFactor.set();
	this.actions = new flixel.group.FlxSpriteGroup();
	this.actions.scrollFactor.set();
	switch(DPad[1]) {
	case 1:
		this.dPad.add(this.add(this.buttonUp = this.createButton(0,flixel.FlxG.height - 85,44,45,flixel.ui._FlxVirtualPad.GraphicUp)));
		this.dPad.add(this.add(this.buttonDown = this.createButton(0,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicDown)));
		break;
	case 2:
		this.dPad.add(this.add(this.buttonLeft = this.createButton(0,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicLeft)));
		this.dPad.add(this.add(this.buttonRight = this.createButton(42,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicRight)));
		break;
	case 3:
		this.dPad.add(this.add(this.buttonUp = this.createButton(35,flixel.FlxG.height - 81,44,45,flixel.ui._FlxVirtualPad.GraphicUp)));
		this.dPad.add(this.add(this.buttonLeft = this.createButton(0,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicDown)));
		this.dPad.add(this.add(this.buttonRight = this.createButton(69,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicRight)));
		break;
	case 4:
		this.dPad.add(this.add(this.buttonUp = this.createButton(35,flixel.FlxG.height - 116,44,45,flixel.ui._FlxVirtualPad.GraphicUp)));
		this.dPad.add(this.add(this.buttonLeft = this.createButton(0,flixel.FlxG.height - 81,44,45,flixel.ui._FlxVirtualPad.GraphicLeft)));
		this.dPad.add(this.add(this.buttonRight = this.createButton(69,flixel.FlxG.height - 81,44,45,flixel.ui._FlxVirtualPad.GraphicRight)));
		this.dPad.add(this.add(this.buttonDown = this.createButton(35,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicDown)));
		break;
	case 0:
		break;
	}
	switch(Action[1]) {
	case 1:
		this.actions.add(this.add(this.buttonA = this.createButton(flixel.FlxG.width - 44,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicA)));
		break;
	case 2:
		this.actions.add(this.add(this.buttonA = this.createButton(flixel.FlxG.width - 44,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicA)));
		this.actions.add(this.add(this.buttonB = this.createButton(flixel.FlxG.width - 86,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicB)));
		break;
	case 3:
		this.actions.add(this.add(this.buttonA = this.createButton(flixel.FlxG.width - 128,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicA)));
		this.actions.add(this.add(this.buttonB = this.createButton(flixel.FlxG.width - 86,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicB)));
		this.actions.add(this.add(this.buttonC = this.createButton(flixel.FlxG.width - 44,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicC)));
		break;
	case 4:
		this.actions.add(this.add(this.buttonY = this.createButton(flixel.FlxG.width - 86,flixel.FlxG.height - 85,44,45,flixel.ui._FlxVirtualPad.GraphicY)));
		this.actions.add(this.add(this.buttonX = this.createButton(flixel.FlxG.width - 44,flixel.FlxG.height - 85,44,45,flixel.ui._FlxVirtualPad.GraphicX)));
		this.actions.add(this.add(this.buttonB = this.createButton(flixel.FlxG.width - 86,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicB)));
		this.actions.add(this.add(this.buttonA = this.createButton(flixel.FlxG.width - 44,flixel.FlxG.height - 45,44,45,flixel.ui._FlxVirtualPad.GraphicA)));
		break;
	case 0:
...
$hxClasses["flixel.ui.FlxVirtualPad"] = flixel.ui.FlxVirtualPad;
flixel.ui.FlxVirtualPad.__name__ = ["flixel","ui","FlxVirtualPad"];
flixel.ui.FlxVirtualPad.__super__ = flixel.group.FlxSpriteGroup;
flixel.ui.FlxVirtualPad.prototype = $extend(flixel.group.FlxSpriteGroup.prototype,{
	buttonA: null
	,buttonB: null
	,buttonC: null
	,buttonY: null
	...
	,actions: null
	,destroy: function() {
		flixel.group.FlxSpriteGroup.prototype.destroy.call(this);
		this.dPad = flixel.util.FlxDestroyUtil.destroy(this.dPad);
		this.actions = flixel.util.FlxDestroyUtil.destroy(this.actions);
		this.dPad = null;
		this.actions = null;
		this.buttonA = null;
		this.buttonB = null;
	...
	,createButton: function(X,Y,Width,Height,Image,OnClick) {
		var button = new flixel.ui.FlxButton(X,Y);
	...
	,__class__: flixel.ui.FlxVirtualPad
});
flixel.ui.DPadMode = $hxClasses["flixel.ui.DPadMode"] = { __ename__ : ["flixel","ui","DPadMode"], __constructs__ : ["NONE","UP_DOWN","LEFT_RIGHT","UP_LEFT_RIGHT","FULL"] };
flixel.ui.DPadMode.NONE = ["NONE",0];
flixel.ui.DPadMode.NONE.toString = $estr;
flixel.ui.DPadMode.NONE.__enum__ = flixel.ui.DPadMode;
flixel.ui.DPadMode.UP_DOWN = ["UP_DOWN",1];
flixel.ui.DPadMode.UP_DOWN.toString = $estr;
flixel.ui.DPadMode.UP_DOWN.__enum__ = flixel.ui.DPadMode;
flixel.ui.DPadMode.LEFT_RIGHT = ["LEFT_RIGHT",2];
flixel.ui.DPadMode.LEFT_RIGHT.toString = $estr;
flixel.ui.DPadMode.LEFT_RIGHT.__enum__ = flixel.ui.DPadMode;
flixel.ui.DPadMode.UP_LEFT_RIGHT = ["UP_LEFT_RIGHT",3];
flixel.ui.DPadMode.UP_LEFT_RIGHT.toString = $estr;
flixel.ui.DPadMode.UP_LEFT_RIGHT.__enum__ = flixel.ui.DPadMode;
flixel.ui.DPadMode.FULL = ["FULL",4];
flixel.ui.DPadMode.FULL.toString = $estr;
flixel.ui.DPadMode.FULL.__enum__ = flixel.ui.DPadMode;
flixel.ui.ActionMode = $hxClasses["flixel.ui.ActionMode"] = { __ename__ : ["flixel","ui","ActionMode"], __constructs__ : ["NONE","A","A_B","A_B_C","A_B_X_Y"] };
flixel.ui.ActionMode.NONE = ["NONE",0];
flixel.ui.ActionMode.NONE.toString = $estr;
flixel.ui.ActionMode.NONE.__enum__ = flixel.ui.ActionMode;
flixel.ui.ActionMode.A = ["A",1];
flixel.ui.ActionMode.A.toString = $estr;
flixel.ui.ActionMode.A.__enum__ = flixel.ui.ActionMode;
flixel.ui.ActionMode.A_B = ["A_B",2];
flixel.ui.ActionMode.A_B.toString = $estr;
flixel.ui.ActionMode.A_B.__enum__ = flixel.ui.ActionMode;
flixel.ui.ActionMode.A_B_C = ["A_B_C",3];
flixel.ui.ActionMode.A_B_C.toString = $estr;
flixel.ui.ActionMode.A_B_C.__enum__ = flixel.ui.ActionMode;
flixel.ui.ActionMode.A_B_X_Y = ["A_B_X_Y",4];
flixel.ui.ActionMode.A_B_X_Y.toString = $estr;
flixel.ui.ActionMode.A_B_X_Y.__enum__ = flixel.ui.ActionMode;
...
flixel.ui._FlxVirtualPad.GraphicA.preload();
flixel.ui._FlxVirtualPad.GraphicB.preload();
flixel.ui._FlxVirtualPad.GraphicC.preload();
flixel.ui._FlxVirtualPad.GraphicDown.preload();
flixel.ui._FlxVirtualPad.GraphicLeft.preload();
flixel.ui._FlxVirtualPad.GraphicRight.preload();
flixel.ui._FlxVirtualPad.GraphicUp.preload();
flixel.ui._FlxVirtualPad.GraphicX.preload();
flixel.ui._FlxVirtualPad.GraphicY.preload();
ApplicationMain.config = { antialiasing : 0, background : 0, borderless : false, depthBuffer : false, fps : 60, fullscreen : false, height : 480, orientation : "portrait", resizable : true, stencilBuffer : false, title : "HOPPE", vsync : true, width : 640};
