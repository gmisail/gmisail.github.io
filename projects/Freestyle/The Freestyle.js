...
ApplicationMain.preload = function() {
	...
	ApplicationMain.loadBinary("assets/maps/default.txt");
...
var DefaultAssetLibrary = function() {
	...
	this.add("assets/images/tiles.png",openfl.AssetType.IMAGE);
	this.add("assets/maps/default.txt",openfl.AssetType.TEXT);
...
PlayState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,create: function() {
		...
		this.pad = new flixel.ui.FlxVirtualPad(flixel.ui.DPadMode.FULL,flixel.ui.ActionMode.NONE);
		this.player = new Player(100,100,this.pad);
		this.map.loadMap(openfl.Assets.getText("assets/maps/default.txt"),"assets/images/tiles.png",16,16,0,1);
		this.add(this.pad);
		this.add(this.map);
...
var Player = function(X,Y,PAD) {
	...
	this.set_y(Y);
	this.pad = PAD;
	this.acceleration.set_y(750);
	this.makeGraphic(16,16,-360334);
};
...
Player.prototype = $extend(flixel.FlxSprite.prototype,{
	...
	,update: function() {
		...
		if(flixel.FlxG.keys.checkStatus(65,flixel.FlxG.keys.pressed.checkStatus) || this.pad.buttonLeft.status == 2) this.velocity.set_x(-this.SPEED);
		if(flixel.FlxG.keys.checkStatus(68,flixel.FlxG.keys.pressed.checkStatus) || this.pad.buttonRight.status == 2) this.velocity.set_x(this.SPEED);
		if(flixel.FlxG.keys.checkStatus(32,flixel.FlxG.keys.pressed.checkStatus) && (this.touching & 4096) > 0 || this.pad.buttonUp.status == 2 && (this.touching & 4096) > 0) this.velocity.set_y(-this.JUMP);
...
ApplicationMain.config = { antialiasing : 0, background : 0, borderless : false, depthBuffer : false, fps : 60, fullscreen : false, height : 480, orientation : "portrait", resizable : true, stencilBuffer : false, title : "The Freestyle", vsync : true, width : 640};
