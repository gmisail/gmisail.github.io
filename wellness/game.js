...
var interests = "I love computing and technology as a whole. Programming in particular is my favorite activity, so much so that I programmed this application. (depending on what browser you are using you can view the source using Right Click -> Inspect Element or -> View Source) Aside from this, I play lacrosse and I'm in the school band. To reach my full potential, I'll need to keep learning and practicing. However, it will be very difficult to do so, as there is always something new to learn and try. ";
